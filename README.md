...
<head>
  ...
  <title>youss-cuisto - Le burger le plus délicieux en ville !</title>
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo">youss-cuisto<span class="span">.</span></a>
      </h1>
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="nav-item">
            <a href="#food-menu" class="navbar-link" data-nav-link>Boutique</a>
          </li>
      ...
      <div class="header-btn-group">
        <button class="search-btn" aria-label="Recherche" data-search-btn>
          <ion-icon name="search-outline"></ion-icon>
        </button>

        <button class="btn btn-hover">Réservation</button>

        <button class="nav-toggle-btn" aria-label="Basculer le menu" data-menu-toggle-btn>
  ...
  <div class="search-container" data-search-container>
    ...
    <div class="search-box">
      <input type="search" name="search" aria-label="Rechercher ici" placeholder="Tapez des mots-clés ici..."
        class="search-input">

      <button class="search-submit" aria-label="Soumettre la recherche" data-search-submit-btn>
        <ion-icon name="search-outline"></ion-icon>
      </button>
    </div>

    <button class="search-close-btn" aria-label="Annuler la recherche" data-search-close-btn></button>
    ...
    <article>
      ...
      <section class="hero" id="home" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">Manger Dormir Et</p>

            <h2 class="h1 hero-title">Le burger le plus délicieux en ville !</h2>

            <p class="hero-text">La nourriture est toute substance consommée pour fournir un soutien nutritionnel à un organisme.</p>
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Pizza Mexicaine</h3>
                <p class="card-text">
                  La nourriture est toute substance consommée pour fournir un soutien nutritionnel à un organisme.
                </p>

                <img src="./assets/images/promo-1.png" width="300" height="300" loading="lazy" alt="Pizza Mexicaine"
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Boissons Fraîches</h3>

                <p class="card-text">
                  La nourriture est toute substance consommée pour fournir un soutien nutritionnel à un organisme.
                </p>

                <img src="./assets/images/promo-2.png" width="300" height="300" loading="lazy" alt="Boissons Fraîches"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Frites Françaises</h3>

                <p class="card-text">
                  La nourriture est toute substance consommée pour fournir un soutien nutritionnel à un organisme.
                </p>

                <img src="./assets/images/promo-3.png" width="300" height="300" loading="lazy" alt="Frites Françaises"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="./assets/images/promo-4.png" width="300" height="300" loading="lazy" alt="Burger King"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Poulet Masala</h3>

                <p class="card-text">
                  La nourriture est toute substance consommée pour fournir un soutien nutritionnel à un organisme.
                </p>

                <img src="./assets/images/promo-5.png" width="300" height="300" loading="lazy" alt="Poulet Masala"
                  class="w-100 card-banner">
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-banner">
            <img src="./assets/images/about-banner.png" width="509" height="459" loading="lazy" alt="Burger avec Boissons"
              class="w-100 about-img">

            <img src="./assets/images/sale-shape-red.png" width="216" height="226" alt="obtenez jusqu'à 50% de réduction maintenant"
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">
              Caferio, Burgers, et les meilleures Pizzas
              <span class="span">en ville !</span>
            </h2>

            <p class="section-text">
              Les restaurants de Hangzhou accueillaient également de nombreux Chinois du Nord qui avaient fui vers le sud depuis Kaifeng pendant
              l'invasion Jurchen des années 1120, et il est également connu que de nombreux restaurants étaient gérés par des familles.
            </p>
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <span class="span">Aliments délicieux et sains</span>
              </li>

              <li class="about-item">
                <ion-icon name="checkmark-outline"></ion-icon>

                <span class="span">Zone spécifique pour la famille et les enfants</span>
              </li>

              <li class="about-item">
                <ion-icon name="checkmark-outline"></ion-icon>

                <span class="span">Musique et autres installations</span>
              </li>

              <li class="about-item">
                <ion-icon name="checkmark-outline"></ion-icon>

                <span class="span">Livraison à domicile la plus rapide</span>
              </li>

            </ul>

            <button class="btn btn-hover">Commander maintenant</button>
      ...
      <section class="section food-menu" id="food-menu">
        <div class="container">
          ...
          <p class="section-subtitle">Plats populaires</p>

          <h2 class="h2 section-title">
            Nos délicieux <span class="span">aliments</span>
          </h2>
          ...
          <ul class="food-menu-list">
              ...
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./assets/images/food-menu-1.png" width="300" height="300" loading="lazy"
                    alt="Poulet frit illimité" class="w-100">

                  <div class="badge">-15%</div>

                  <button class="btn food-menu-btn">Commander maintenant</button>
                </div>

                <div class="wrapper">
                  <p class="category">Poulet</p>
                ...
                <h3 class="h3 card-title">Poulet frit illimité</h3>

                <div class="price-wrapper">

                  <p class="price-text">Prix :</p>
              ...
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./assets/images/food-menu-2.png" width="300" height="300" loading="lazy"
                    alt="Whopper Burger King" class="w-100">
                ...
                <h3 class="h3 card-title">Whopper Burger King</h3>
            ...
            <!-- More food menu items would follow here -->
        ...
        <div class="food-menu-card">
          ...
          <div class="card-banner">
            <img src="./assets/images/food-menu-3.png" width="300" height="300" loading="lazy"
              alt="Pizzas White Castle" class="w-100">
          ...
          <h3 class="h3 card-title">Pizzas White Castle</h3>
        ...
        <div class="food-menu-card">
          ...
          <div class="card-banner">
            <img src="./assets/images/food-menu-4.png" width="300" height="300" loading="lazy"
              alt="Burrito Suprême Bell" class="w-100">
          ...
          <h3 class="h3 card-title">Burrito Suprême Bell</h3>
      ...
      <section class="section section-divider white cta" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <div class="cta-content">
            ...
            <h2 class="h2 section-title">
              Le youss-cuisto a d'excellents
              <span class="span">Burgers de qualité !</span>
            </h2>
          ...
          <figure class="cta-banner">
            ...
            <img src="./assets/images/sale-shape.png" width="216" height="226" loading="lazy"
              alt="obtenez jusqu'à 50% de réduction maintenant" class="abs-img scale-up-anim">
          </figure>
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <div class="delivery-content">
            ...
            <h2 class="h2 section-title">
              Un moment de livraison au <span class="span">bon moment</span> et au bon endroit
            </h2>
          ...
          <figure class="delivery-banner">
            <img src="./assets/images/delivery-banner-bg.png" width="700" height="602" loading="lazy" alt="nuages"
              class="w-100">

            <img src="./assets/images/delivery-boy.svg" width="1000" height="880" loading="lazy" alt="livreur"
      ...
      <section class="section section-divider white testi">
        <div class="container">
          ...
          <h2 class="h2 section-title">
            Avis de <span class="span">nos clients</span>
          </h2>
          ...
          <ul class="testi-list has-scrollbar">
              ...
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <div>
                    ...
                    <p class="testi-title">PDG Kingfisher</p>
                  </div>

                </div>

                <blockquote class="testi-text">
                  "Je serais perdu sans restaurant. Je tiens à vous remercier personnellement pour votre
              ...
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <div>
                    ...
                    <p class="testi-title">PDG Getforce</p>
                  </div>
            ...
            <!-- More testimonial items would follow here -->
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="./assets/images/banner-1.jpg" width="550" height="450" loading="lazy"
                  alt="Réduction sur des burgers délicieux !" class="banner-img">

                <div class="banner-item-content">
                  <p class="banner-subtitle">50% de réduction maintenant !</p>

                  <h3 class="banner-title">Réduction sur des burgers délicieux !</h3>

                  <p class="banner-text">Solde de 50% seulement cette semaine</p>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="./assets/images/banner-2.jpg" width="550" height="465" loading="lazy" alt="Pizza délicieuse"
                  class="banner-img">

                <div class="banner-item-content">
                  <h3 class="banner-title">Pizza délicieuse</h3>

                  <p class="banner-text">50% de réduction maintenant</p>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="./assets/images/banner-3.jpg" width="550" height="465" loading="lazy" alt="Burgers américains"
                  class="banner-img">

                <div class="banner-item-content">
                  <h3 class="banner-title">Burgers américains</h3>
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="./assets/images/banner-4.jpg" width="550" height="220" loading="lazy" alt="Pizza savoureuse"
                  class="banner-img">

                <div class="banner-item-content">
                  <h3 class="banner-title">Pizza savoureuse</h3>
      ...
      <section class="section section-divider white blog" id="blog">
        <div class="container">
          ...
          <p class="section-subtitle">Derniers articles de blog</p>

          <h2 class="h2 section-title">
            Tout sur la <span class="span">nourriture</span>
          </h2>
          ...
          <ul class="blog-list">
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <time class="meta-info" datetime="2022-01-01">1 Jan 2022</time>
                    </a>
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">Que pensez-vous des recettes de pizza au fromage ?</a>
                  </h3>

                  <p class="card-text">
                    Les experts financiers vous soutiennent ou vous aident à trouver comment vous pouvez augmenter vos fonds davantage...
                  </p>
            ...
            <!-- More blog items would follow here -->
    ...
    <div class="footer-top" style="background-image: url('./assets/images/footer-illustration.png')">
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-title">Coordonnées</p>
          </li>
          ...
          <li>
            <p class="footer-list-item">Info@VotreGmail24.com</p>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">Lundi-Vendredi : 08:00-22:00</p>
          </li>

          <li>
            <p class="footer-list-item">Mardi 16h : Jusqu'à minuit</p>
          </li>

          <li>
            <p class="footer-list-item">Samedi : 10:00-16:00</p>
          </li>
        ...
        <form action="" class="footer-form">
          ...
          <p class="footer-list-title">Réserver une table</p>

          <div class="input-wrapper">

            <input type="text" name="full_name" required placeholder="Votre nom" aria-label="Votre nom"
              class="input-field">
          ...
          <div class="input-wrapper">
            ...
            <select name="total_person" aria-label="Nombre de personnes" class="input-field">
            ...
            <input type="date" name="booking_date" aria-label="Date de réservation" class="input-field">
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright-text">
          &copy; 2022 <a href="#" class="copyright-link">Dr-fluttere</a> Tous droits réservés.
        </p>
      </div>
    </div>
